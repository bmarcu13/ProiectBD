...
INNER JOIN programare ON bon_fiscal.id_programare = programare.id_programare AND programare.cnp_medic = _cnp_medic AND MONTH(programare.data_programare) = MONTH(_month)
